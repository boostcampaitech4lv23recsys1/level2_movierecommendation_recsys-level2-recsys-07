...
class DataLoaderBase(object):
    ...
    def __init__(self, args, logging):
        ...
        self.test_file = os.path.join(self.data_dir, 'test.csv')
        ...
        self.cf_train_data, self.train_user_dict = self.load_cf_df(self.train_file)
        self.cf_test_data, self.test_user_dict = self.load_cf_df(self.test_file)
        self.statistic_cf()
    ...
    def load_kg_df(self, filename):
        kg_data = pd.read_csv(filename, engine='python')
        kg_data = kg_data.drop_duplicates()
        return kg_data
