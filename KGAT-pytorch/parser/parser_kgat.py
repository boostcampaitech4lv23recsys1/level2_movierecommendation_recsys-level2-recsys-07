...
def parse_kgat_args():
    ...
    parser.add_argument('--data_name', nargs='?', default='custom',
    ...
    parser.add_argument('--pretrain_model_path', nargs='?', default='/opt/ml/input/recbole/KGAT-pytorch/trained_model/KGAT/custom/embed-dim64_relation-dim64_random-walk_bi-interaction_64-32-16_lr0.0001_pretrain0/model_epoch100.pth',
    ...
    parser.add_argument('--Ks', nargs='?', default='[10, 20, 40, 60, 80]',
